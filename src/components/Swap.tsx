...
const Swap = () => {
    ...
    //Ethereumのstateから値を呼び出すような時間がかかる処理はuseEffectを使う
    useEffect(() => {
    ...
    //useEffect(() => {},[]) → {}:関数（実行したいことを書く）、[]:リスト（実行のトリガーを書く）

    //then:Promiseの結果が得られたときに実行する処理
    useEffect(() => {
            ...
            <div className={style.container}>
                ...
                <div className={style.currencyContainer}>
                    ...
                    <div className={style.currencySelectorContainer}>
                        ...
                        <div className={style.currencyBalanceContainer}>
                            <div className={style.currencyBalance}>
                                {inField.displayBalance != "" ? <>{`Balance: ${outField.displayBalance}`}</> : null}
                            </div>
                        </div>
                    </div>
                </div>
